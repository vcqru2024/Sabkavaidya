<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.CP_Product.View.P_Settings_VendorProfile, App_Web_p_settings_vendorprofile.ascx.87459c53" %>
...
<table id="tblVendorProfile" cellspacing="0" cellpadding="2" border="0" runat="server" class="dnnFormItem" width="100%">
     ...
     <tr>
        <td colspan="2">
            <asp:Label ID="Label3" runat="server" resourcekey="Tip_VendorProfile" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
        </td>
    </tr>
