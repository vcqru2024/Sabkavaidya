...
namespace Cross.Modules.CP_Product.View
{
    ...
    public partial class ProductVendorProfile : CPModuleBase
    {
        /// <summary>
        /// maintain current status, can be 
        /// none/localsearch_basic/localsearch_advanced/
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LocalResourceFile = Localization.GetResourceFile(this, "ProductVendorProfile.ascx");
        ...
        private List<ProductInfo> GetProducts_None(int pageIndex, ref int pageSize, ref int totalRecords)
        {
          ...
          , pageSize, Settings_VendorProfile.Product_Paging.ShowPage,
        ...
        private List<ProductInfo> GetProducts_LocalSearch_Basic(int pageIndex, ref int pageSize, ref int totalRecords)
        {
          ...
          Settings_VendorProfile.Product_Search_Basic.ShowSortInSearch ? ddlSortField.SelectedValue : Settings_VendorProfile.General.SortField,
           pageSize, Settings_VendorProfile.Product_Paging.ShowPage, GetCurrentCultureCode(), pageSize, pageIndex, ref totalRecords);
        ...
        protected void grProduct_DataBinding(object sender, EventArgs e)
        {
            ...
            if (grProduct.Columns[10] != null)//package fee
            {
                grProduct.Columns[10].Visible = Settings_VendorProfile.Product_Content.ShowPackageFee && CurrentType.FieldEnable_PackageFee;
            }
            if (grProduct.Columns[11] != null)//Price
            {
                grProduct.Columns[11].Visible = Settings_VendorProfile.Product_Content.ShowPrice && CurrentType.FieldEnable_Price;
            }
            if (grProduct.Columns[12] != null)//PromoStart
            {
                grProduct.Columns[12].Visible = Settings_VendorProfile.Product_Content.ShowPromoStart && CurrentType.FieldEnable_Price;
            }
            if (grProduct.Columns[13] != null)//PromoEnd
            {
                grProduct.Columns[13].Visible = Settings_VendorProfile.Product_Content.ShowPromoEnd && CurrentType.FieldEnable_Price;
            }
            if (grProduct.Columns[14] != null)//CreatedDate
            {
                grProduct.Columns[14].Visible = Settings_VendorProfile.Product_Content.ShowCreatedDate;
            }

            if (grProduct.Columns[15] != null)//Featured
            {
                grProduct.Columns[15].Visible = Settings_VendorProfile.Product_Content.ShowFeaturedField;
            }


            if (grProduct.Columns[16] != null)//Summary
            {
                grProduct.Columns[16].Visible = Settings_VendorProfile.Product_Content.ShowSummary && CurrentType.FieldEnable_Summary;
            }
