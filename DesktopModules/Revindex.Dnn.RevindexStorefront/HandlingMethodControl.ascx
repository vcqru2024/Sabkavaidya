        ...
        <ContentTemplate>
            ...
            <asp:MultiView ID="ContentMultiView" runat="server">
                <asp:View ID="ListView" runat="server">
                    <h2><%= LocalizeString("HandlingMethodsHeader") %></h2>
                ...
                <asp:View ID="DetailsView" runat="server">
                    ...
                    <h2><%= LocalizeString("HandlingMethodHeader") %>: <uc1:BreadcrumbControl ID="BreadcrumbControl" runat="server" /><asp:Label runat="server" ID="HandlingMethodIDLabel" CssClass="badge badge-secondary rvdsf-badge-small"></asp:Label></h2>
                    <div id="HandlingMethodDetailsViewTabPanel" >
                        <hr/>
                        <fieldset>
