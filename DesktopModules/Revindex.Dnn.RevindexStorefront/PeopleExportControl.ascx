<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PeopleExportControl.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.PeopleExportControl" %>
...
<div>
	<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
		...
		<ContentTemplate>
			...
			<h2><%= LocalizeString("ExportPeopleHeader") %></h2>
					...
					<fieldset>
						<div class="dnnFormItem">
							...
							<asp:DropDownList ID="EntityTypeDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="EntityTypeDropDownList_SelectedIndexChanged">
								...
								<asp:ListItem Text="QuickBooks customer" Value="QuickBooksCustomer" />
							</asp:DropDownList>
						</div>
						<div class="dnnFormItem">
