...
<div class="saatvik-navbar">
    <div class="top-bar-navbar d-lg-block d-none">
        <div class="container-fluid">
            <div class="row align-items-center g-0">
                ...
                <div class="col-lg-6 text-end">
                    <a href="tel:" class="btn btn-primary btn-sm"><i class="fa-solid fa-phone"></i>+91 987456321</a>
                    <%
    ...
    <div class="bottom-bar">
        <div class="container-fluid">
            <nav id="to-shine-page-navigation" class="navbar navbar-expand-lg">
                ...
                <dnn:LOGO runat="server" ID="LOGO1" CssClass="d-lg-none d-block" />
                ...
                <div class="offcanvas offcanvas-start" id="offcanvasNavbar" tabindex="-1">
                    ...
                    <div class="offcanvas-body">
                        <%--<div class="d-flex flex-column justify-content-end align-items-end flex-grow-1"></div>--%>
...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        AttachCustomHeader("<link href='https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800;900&display=swap'rel='stylesheet'>");
        AttachCustomHeader("<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css' integrity='sha512-z3gLpd7yknf1YoNbCzqRKc4qyor8gaKU1qmn+CShxbuBusANI9QpRohGBreCFkKxLhei6S9CQXFEbbKuqLg0DA=='crossorigin='anonymous' referrerpolicy='no-referrer' />");
