             ...
             <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar">
                ...
                <div class="offcanvas offcanvas-start" id="offcanvasNavbar" tabindex="-1">
                    ...
                    <%
                        ...
                        {
                    %>
                   <a href="?ctl=logoff" title="Logoff" class="to-shine-login btn btn-login" target="_self">Logout
                    ...
                    <%
                        ...
                        {
                    %>
                      <a href="?ctl=login" title="Login" class="to-shine-login btn btn-login" target="_self">Login
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-lg-12 order-lg-2 ly-col-contentpane">
                ...
                <div id="Div2" runat="server" containertype="G" containername="2shineBS5" containersrc="fullwidthWithoutPadding.ascx"></div>
...
<%--<footer id="to-shine-page-footer">
    <div class="container py-4 d-flex justify-content-md-between flex-column flex-md-row text-white">
        <ul class="to-shine-footer-address" itemscope itemtype="http://schema.org/LocalBusiness">
            <li>
                <strong itemprop="name">Satvik Health </strong>sss
            </li>
            <li>
