...
<!--#include file="controls/ourcenter-body.ascx"-->
<%
                    if (Request.QueryString["ctl"] != "login")
                    {
%>
<section class="all-services">
    <div class="container">
        <div class="web-heading" id="webheading" runat="server" containertype="G" containername="2shineBS5" containersrc="default.ascx">
        </div>
        <div id="centercard" runat="server" containertype="G" containername="2shineBS5" containersrc="default.ascx">

        </div>
    </div>
    <div id="Footerourcenter" runat="server" containertype="G" containername="2shineBS5" containersrc="default.ascx"></div>
</section>
