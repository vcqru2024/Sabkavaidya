<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.CP_Product.View.AdminProduct_Order, App_Web_adminproduct_order.ascx.87459c53" %>
...
<table width="100%" class="dnnFormItem" cellpadding="0" cellspacing="0" border="0" runat="server"
    ...
    <tr>
        <td id="td_Button_Search" runat="server">
            ...
            <asp:TextBox ID="txtOrderNo" Columns="40" runat="server" Width="400px"/><br />
            ...
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray"
                ...
                <Columns>
                    ...
                    <asp:TemplateField >
                        ...
                        <ItemTemplate>
                            <asp:Label ID="hlUserNameData" runat="server" Text='<%# Eval("UserName") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
