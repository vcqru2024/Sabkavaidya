<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.CP_Product.View.AdminType_Auction, App_Web_admintype_auction.ascx.87459c53" %>
...
<div id="divTypeDetail" runat="server">
    ...
    <div id="tabs" style="width: 100%; overflow:hidden">
        <ul>
            ...
            <li><a href="#divAuction"><span>
                <%#Localization.GetString("divAuction", LocalResourceFile)%></span></a>
            </li>
            ...
            <table cellspacing="0" cellpadding="6" width="100%" border="0" align="left">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RadioButtonList ID="rblSellType_Auction" runat="server">
                ...
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label34" runat="server" resourcekey="Tip_Auction" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plAuctionType" runat="server" ControlName="rblAuctionType"></dnn:Label>
                    </td>
                    <td>
                        <asp:RadioButtonList ID="rblAuctionType" runat="server"  OnSelectedIndexChanged="rblAuctionType_SelectedIndexChanged" AutoPostBack="True">
                            <asp:ListItem Value="0" resourcekey="li_ActionType_English" Selected="True"></asp:ListItem>
                            <asp:ListItem Value="1" resourcekey="li_ActionType_Sealed_first_price"></asp:ListItem>
                            <asp:ListItem Value="2" resourcekey="li_ActionType_Vickrey"></asp:ListItem>
                            <asp:ListItem Value="3" resourcekey="li_ActionType_Second_item"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr runat="server" id="tr_Tip_ProxyBidding">
                    <td colspan="2">
                        <asp:Label ID="Label14" runat="server" resourcekey="Tip_ProxyBidding" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr runat="server" id="tr_AllowProxyBidding">
                    <td>
                        <dnn:Label ID="plAllowProxyBidding" runat="server" ControlName="chkAllowProxyBidding">
                        </dnn:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkAllowProxyBidding" runat="server" />
                    </td>
                </tr>
                <tr runat="server" id="tr_MaxAuctionDays">
                    <td>
                        <dnn:Label ID="plMaxAuctionDays" runat="server" ControlName="txtMaxAuctionDays">
                        </dnn:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtMaxAuctionDays" runat="server" Columns="10" Text="30"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="Regularexpressionvalidator1" resourcekey="MustBeInteger"
                            runat="server" ValidationExpression="\d*" ControlToValidate="txtMaxAuctionDays"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                 <tr  runat="server" id="tr_BidIncrement">
                    <td>
                        <dnn:Label ID="plBidIncrement" runat="server" ControlName="txtBidIncrement"></dnn:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtBidIncrement" Columns="10" runat="server" Text="10" />
                    </td>
                </tr>
        ...
        <div id="divAuction" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="6" width="100%" border="0" align="left">
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label21" runat="server" resourcekey="Tip_AuctionType" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                        <br />
                    </td>
                </tr>
            </table>
        ...
        <div id="divFileUpload_Vendor" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label16" runat="server" resourcekey="Tip_FileUpload_Vendor" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 200px">
