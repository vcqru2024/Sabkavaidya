<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.CP_Product.View.AdminType_Fixed, App_Web_admintype_fixed.ascx.87459c53" %>
...
<script type="text/javascript">
    ...
    function checkAll_VariantGroup() {
        if ($(":checkbox[id*='chkAllVariantGroup']").prop("checked") == true) {
            $(":checkbox[id*='chkItemVariantGroup']").prop("checked", true);
        }
        else {
            $(":checkbox[id*='chkItemVariantGroup']").prop("checked", false);
        }
    }
    $(function () {
        $("#tabs").tabs();
        ...
        <td align="left">
            <asp:GridView ID="gvTypeList" runat="server" AutoGenerateColumns="False" CellPadding="1"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblSellType" runat="server" resourcekey="lblSellType">SellType</asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblSellTypeData" runat="server" Text='<%# GetSellType(Eval("SellType").ToString()) %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblEnableTax" runat="server" resourcekey="lblEnableTax">EnableTax</asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:CheckBox ID="lblEnableTaxData" runat="server" Checked='<%# Eval("EnableTax") %>'
                                Enabled="false" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblChargePercent" runat="server" resourcekey="lblChargePercent"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblChargePercentData" runat="server" Text='<%# Eval("ChargePercent") %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                        <HeaderTemplate>
                            <asp:Label ID="lblTax" runat="server" resourcekey="lblTax"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:ImageButton ID="imgTax" runat="server" CausesValidation="False" CommandName="Tax"
                                CommandArgument='<%# Eval("Id")%>' ToolTip='<%#Localization.GetString("imgTax",LocalResourceFile)%>'
                                ImageUrl="~/DesktopModules/CrossClassified/images/Option.gif" AlternateText='<%#Localization.GetString("imgTax", LocalResourceFile)%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                        <HeaderTemplate>
                            <asp:Label ID="lblVariantGroup" runat="server" resourcekey="lblVariantGroup"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:ImageButton ID="imgVariantGroup" runat="server" CausesValidation="False" CommandName="VariantGroup"
                                CommandArgument='<%# Eval("Id")%>' ToolTip='<%#Localization.GetString("imgVariantGroup",LocalResourceFile)%>'
                                ImageUrl="~/DesktopModules/CrossClassified/images/Variant16.gif" AlternateText='<%#Localization.GetString("imgVariantGroup", LocalResourceFile)%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
        ...
        <td>
            <div class="dnnTreeLegend" id="divLegend" runat="server">
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="lblTax" runat="server" Text='<%#Localization.GetString("imgTax", LocalResourceFile)%>' />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <img alt="" id="Img3" runat="server" src="~/DesktopModules/CrossClassified/images/Variant16.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="Literal1" runat="server" Text='<%#Localization.GetString("imgVariantGroup", LocalResourceFile)%>' />
                </div>
            </div>
        </td>
    </tr>
    ...
    <div id="tabs" style="width: 100%; overflow: hidden">
        ...
        <div id="divBasic" class="dnnFormItem" style="height: 100%">
            <table cellspacing="2" cellpadding="6" width="100%" border="0">
                ...
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label2" runat="server" resourcekey="Tip_SellType" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plSellType" runat="server"></dnn:Label>
                    </td>
                    <td>
                        <asp:RadioButtonList ID="rblSellType_FixedPrice" runat="server">
                            <asp:ListItem Value="0" resourcekey="li_SellType_Goods" Selected="True"></asp:ListItem>
                            <asp:ListItem Value="1" resourcekey="li_SellType_Software"></asp:ListItem>
                            <asp:ListItem Value="2" resourcekey="li_SellType_Role"></asp:ListItem>
                            <asp:ListItem Value="3" resourcekey="li_SellType_Other"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plEnableTax" runat="server" ControlName="chkEnableTax"></dnn:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkEnableTax" runat="server" />
                    </td>
                </tr>
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label4" runat="server" resourcekey="Tip_AllowRecursiveBill" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plAllowRecursiveBill" runat="server" ControlName="chkAllowRecursiveBill">
                        </dnn:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkAllowRecursiveBill" runat="server" />
                    </td>
                </tr>
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label5" runat="server" resourcekey="Tip_ChargePercent" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plChargePercent" runat="server" ControlName="txtChargePercent"></dnn:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtChargePercent" runat="server" Columns="10" Text="0"></asp:TextBox>%
                    </td>
                </tr>
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label6" runat="server" resourcekey="Tip_RequireAddress" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plRequireAddress" runat="server" ControlName="chkRequireAddress">
                        </dnn:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkRequireAddress" runat="server" />
                    </td>
                </tr>
        ...
        <div id="divGoogleMap" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="6" width="100%" border="0">
                ...
                <tr>
                    <td style="width: 200px">
                        <dnn:Label ID="plAllowLocation" runat="server" ControlName="chkAllowLocation"></dnn:Label>
                    </td>
                    <td>
        ...
        <div id="divFileUpload" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label14" runat="server" resourcekey="Tip_FileUpload" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 200px">
                        <dnn:Label ID="plAllowUploadForOrder" runat="server" ControlName="chkAllowUploadForOrder">
                        </dnn:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkAllowUploadForOrder" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
         ...
         <div id="divFileUpload_Vendor" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                <tr runat="server" Visible="<%#!Settings_Portal.General.HideAllTips %>">
                    <td colspan="2">
                        <asp:Label ID="Label15" runat="server" resourcekey="Tip_FileUpload_Vendor" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 300px">
                        <dnn:Label ID="plAllowUploadForOrder_Vendor" runat="server" ControlName="chkAllowUploadForOrder_Vendor">
                        </dnn:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkAllowUploadForOrder_Vendor" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
...
<table width="100%" class="dnnFormItem" align="left" runat="server" id="tblTaxList">
    <tr>
        <td>
            <asp:Label ID="lblTaxList" runat="server" CssClass="SubHead"></asp:Label><br />
            <asp:GridView ID="gvTaxList" runat="server" AutoGenerateColumns="False" CellPadding="1"
                CellSpacing="1" GridLines="Both" BackColor="Gray" Width="100%" ForeColor="#333333"
                DataKeyNames="Id" OnRowCommand="gvTaxList_RowCommand">
                <EmptyDataTemplate>
                ...
                <Columns>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <input type="checkbox" id="chkAllTax" runat="server" onclick="checkAll_Tax()" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:CheckBox ID="chkItemTax" runat="server" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField Visible="False">
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblTaxRate" runat="server" resourcekey="lblTaxRate"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblTaxRateField" runat="server" Text='<%#Eval("TaxRate") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <HeaderTemplate>
...
<table id="tblTaxDetail" cellspacing="0" cellpadding="2" width="100%" border="0"
    ...
    <tr>
        <td>
            <dnn:Label ID="plTaxRate" runat="server" ControlName="txtTaxRate"></dnn:Label>
        </td>
        <td>
            <asp:TextBox ID="txtTaxRate" runat="server" Columns="10" Text="0"></asp:TextBox>%
        </td>
    </tr>
</table>


<table width="100%" class="dnnFormItem" align="left" runat="server" id="tblVariantGroupList">
    <tr>
        <td>
            <asp:Label ID="lblVariantGroupList" runat="server" CssClass="SubHead"></asp:Label><br />
            <asp:GridView ID="gvVariantGroupList" runat="server" AutoGenerateColumns="False" CellPadding="1"
                CellSpacing="1" GridLines="Both" BackColor="Gray" Width="100%" ForeColor="#333333"
                DataKeyNames="Id" OnRowCommand="gvVariantGroupList_RowCommand">
                <EmptyDataTemplate>
                    <asp:Label ID="lblNoRecordes" Text='<%# Localization.GetString("NoRecords", Cross.Modules.CP_Product.Business.LocalUtils.ResourcesFile_Shared) %>'
                        runat="server"></asp:Label>
                </EmptyDataTemplate>
                <Columns>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <input type="checkbox" id="chkAllVariantGroup" runat="server" onclick="checkAll_VariantGroup()" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:CheckBox ID="chkItemVariantGroup" runat="server" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField Visible="False">
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                        <HeaderTemplate>
                            <asp:Label ID="lblVariantGroupName" runat="server" resourcekey="lblVariantGroupName"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblVariantGroupNameField" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgDel" runat="server" CausesValidation="False" CommandName="Del"
                                ...
                                OnClientClick='<%# String.Format("return confirm(\"{0}\");", Localization.GetString("DeleteItem",Cross.Modules.CP_Product.Business.LocalUtils.ResourcesFile_Shared)) %>' />
                            <asp:HyperLink ID="hlContentLocalization" Target="_blank" ImageUrl="~/DesktopModules/CrossClassified/images/ml_content_16.gif"
                                Visible="<%#SupportsContentLocalization%>" runat="server" NavigateUrl='<%# EditUrl("ContentLocalize_Misc") + "?Table=VariantGroup&ItemId=" + Eval("Id").ToString() %>' />
...
<table id="tblVariantGroupDetail" cellspacing="0" cellpadding="2" width="100%" border="0"
    class="dnnFormItem" align="left" runat="server">
    <tr>
        <td style="width: 200px">
            <dnn:Label ID="plVariantGroupName" runat="server" ControlName="txtVariantGroupName">
            </dnn:Label>
        </td>
        <td>
            <asp:TextBox ID="txtVariantGroupName" runat="server"></asp:TextBox>
            <asp:Image ID="Image8" runat="server" ImageUrl="~/DesktopModules/CrossClassified/images/required.jpg"
                ToolTip="Reuired" AlternateText="Required" />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtVariantGroupName"
                ForeColor="Red" Display="Dynamic" resourcekey="Required"></asp:RequiredFieldValidator>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <dnn:Label ID="plVariantGroupSortIndex" runat="server" ControlName="txtVariantGroupSortIndex"></dnn:Label>
        </td>
        <td>
            <asp:TextBox ID="txtVariantGroupSortIndex" runat="server" Text="100"></asp:TextBox>
             <asp:RegularExpressionValidator ID="Regularexpressionvalidator1" resourcekey="MustBeInteger"
                runat="server" ValidationExpression="^-?\d+$" ControlToValidate="txtVariantGroupSortIndex">
             </asp:RegularExpressionValidator>
        </td>
    </tr>
</table>
