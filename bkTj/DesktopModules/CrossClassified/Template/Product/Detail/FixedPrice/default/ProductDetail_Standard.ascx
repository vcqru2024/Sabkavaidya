<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductDetail.ascx.cs"
    Inherits="Cross.Modules.CP_Product.View.ProductDetail" %>
...
<table cellspacing="2" cellpadding="2" width="100%" class="Normal">
    <tr>
        <td align="left" colspan="2">
            <asp:Label ID="lblProductName" CssClass="Head" runat="server" Text="<%#objProduct.Name%>"
                ...
                <asp:Label ID="lblOutOfStock" runat="server" resourcekey="lblOutOfStock" CssClass="NormalRed" Visible="false"/>
                &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
          <!--    product image -->
        <td align="left" runat="server" id="tdImage" valign="top" 
            visible="<%#Settings_Detail.MainImage.ShowMainImage && !string.IsNullOrEmpty(objProduct.Image.Trim())%>"
            >
            <a href="<%=GetRelativeUrlByFileId(objProduct.Image) %>" target="_blank" title="<%#objProduct.Name%>">
        ...
        <td valign="top" align="left">
            <table cellspacing="2" cellpadding="2" width="100%"  align="left" runat="server">
                  <!-- Creator -->
                <tr runat="server" visible="<%#Settings_Detail.General.ShowAuthor %>">
                 ...
                 <!--    country-->
                 <tr   runat="server" visible="<%#Settings_Detail.General.ShowLocation_Country 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.Country)%>">
                    ...
                    <!--    State-->
                 <tr  runat="server" visible="<%#Settings_Detail.General.ShowLocation_State 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.State)%>">
                   ...
                   <!--    City-->
                 <tr    runat="server" visible="<%#Settings_Detail.General.ShowLocation_City 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.City)%>">
                   ...
                   <!--    Town-->
                 <tr    runat="server" visible="<%#Settings_Detail.General.ShowLocation_Town 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.Town)%>">
                  ...
                  <!--    sku -->
                 <tr  runat="server" visible="<%#Settings_Detail.General.ShowSku && objType.FieldEnable_Sku%>">
                    <td>
                  ...
                  <!--    Weight -->
                  <tr  runat="server" visible="<%#Settings_Detail.General.ShowWeight && objType.FieldEnable_Weight%>">
                    <td>
                ...
                <!--    PackageFee -->
                  <tr runat="server" visible="<%#Settings_Detail.Order.ShowPackageFee && objType.FieldEnable_PackageFee%>">
                    <td>
                  ...
                  <!--    views -->
                <tr runat="server" visible="<%#Settings_Detail.General.ShowViews%>">
                    <td>
               ...
               <!--    PublishDate, normally don't need in fixed price product -->
                 <tr runat="server" visible="<%#Settings_Detail.General.ShowPublishDate%>">
                    <td>
                 ...
                 <tr  runat="server" visible="<%#Settings_Detail.General.ShowExpireDate%>">
                    <td>
                 ...
                 <!--    Last Modified Date -->
                 <tr  runat="server" visible="<%#Settings_Detail.General.ShowLastModifiedDate%>">
                    <td>
                ...
                <!--   summary -->
                    <tr valign="top" runat="server" visible="<%#Settings_Detail.General.ShowSummary && objType.FieldEnable_Summary%>">
                    <td colspan="2">
                        &nbsp;&nbsp;<%#Server.HtmlDecode(objProduct.Summary) %>
                    </td>
                </tr>
                  <!--  tags  -->
                <tr runat="server" visible="<%#Settings_Detail.Tag.ShowTags %>">
                    <td>
                ...
                <tr>
                  ...
                  <!--  purchase price  -->
                <tr runat="server" visible="<%#Settings_Detail.Order.ShowPrice && objType.FieldEnable_Price%>">
                    <td>
                  ...
                  <!--  promo price  -->
                <tr runat="server" visible='<%#objProduct.PromoPriceAvailable && Settings_Detail.Order.ShowPrice && objType.FieldEnable_Price %>'>
                    <td>
                    ...
                    <td class="NormalRed">
                      ...
                      <%--   <%#Settings_Portal.Order.CurrencySymbol + string.Format("{0:#######}",objProduct.PromoPrice) %>--%>
                    </td>
                </tr>
                <!--  promo start  -->
                <tr runat="server" visible='<%#objProduct.PromoPriceAvailable && Settings_Detail.Order.ShowPrice && Settings_Detail.Order.ShowPromoStart && objType.FieldEnable_Price %>'>
                    <td>
                 ...
                 <!--  promo end  -->
                <tr runat="server" visible='<%#objProduct.PromoPriceAvailable && Settings_Detail.Order.ShowPrice && Settings_Detail.Order.ShowPromoEnd&&objType.FieldEnable_Price %>'>
                    <td>
                  ...
                  <!--  shipping options  -->
                <tr runat="server" visible='<%# objType.SellType == Convert.ToInt16(Cross.Modules.CP_Product.Business.SellType.Goods) && Settings_Detail.Order.ShowOrderShippingOption %>'>
                    <td>
                ...
                <tr>
                 ...
                 <!--  Stock Quantity   -->
                <tr runat="server" visible="<%#Settings_Detail.Order.ShowStockQuantity && objProduct.StockQuantity!=-1 && objType.FieldEnable_StockQuantity%>">
                    <td>
                ...
                <!--  options   -->
                <tr valign="top" runat="server" visible="<%#ShowOptionList%>" >
                    <td colspan="2" width="100%">
                        <asp:Label ID="lblChooseOption" resourcekey="lblChooseOption" runat="server"></asp:Label><br />
                        <asp:RadioButtonList runat="server" ID="rblOption" BorderWidth="1" BorderColor="CadetBlue" width="100%"/>
                    </td>
                </tr>
                 <!--  Varaint 1    -->
                <tr id="trVaraint_1" runat="server" visible="<%#HasVariant_1%>" class="dnnFormItem">
                    <td>
                        <%#VariantGroupName_1 + ":"%>
                    </td>
                    <td>
                        <asp:RadioButtonList runat="server" ID="rblVariant_1"  RepeatColumns="20"  CellSpacing="8"/>
                    </td>
                </tr>
                 <!--  Varaint 2    -->
                <tr id="trVaraint_2" runat="server" visible="<%#HasVariant_2%>" class="dnnFormItem">
                    <td>
                        <%#VariantGroupName_2 + ":"%>
                    </td>
                    <td>
                        <asp:RadioButtonList runat="server" ID="rblVariant_2" RepeatColumns="20"   CellSpacing="8"/>
                    </td>
                </tr>
                  <!--  Varaint 3    -->
                <tr id="trVaraint_3" runat="server" visible="<%#HasVariant_3%>" class="dnnFormItem">
                    <td>
                        <%#VariantGroupName_3 + ":"%>
                    </td>
                    <td>
                        <asp:RadioButtonList runat="server" ID="rblVariant_3" RepeatColumns="20"  CellSpacing="8"/>
                    </td>
                </tr>
                 <!--  Varaint 4    -->
                <tr id="trVaraint_4" runat="server" visible="<%#HasVariant_4%>" class="dnnFormItem">
                    <td>
                        <%#VariantGroupName_4 + ":"%>
                    </td>
                    <td>
                        <asp:RadioButtonList runat="server" ID="rblVariant_4" RepeatColumns="20"  CellSpacing="8"/>
                    </td>
                </tr>
                  <!--  Varaint 5    -->
                <tr id="trVaraint_5" runat="server" visible="<%#HasVariant_5%>" class="dnnFormItem">
                    <td>
                        <%#VariantGroupName_5 + ":"%>
                    </td>
                    <td>
                        <asp:RadioButtonList runat="server" ID="rblVariant_5" RepeatColumns="20"  CellSpacing="8"/>
                    </td>
                </tr>
                 <!--  Order Count   -->
                <tr runat="server" visible="<%#Sellable && Settings_Detail.Order.ShowOrderCount%>" class="dnnFormItem">
                    <td >
                        <asp:Label ID="lblOrderCount" runat="server" resourcekey="lblOrderCount"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="txtOrderCount" Text="1"  Width="60px"/>
                ...
                runat="server" ValidationExpression="\d*" ControlToValidate="txtOrderCount"></asp:RegularExpressionValidator>
                        <asp:Label ID="lblInvalidQuantity" runat="server" resourcekey="lblInvalidQuantity" CssClass="NormalRed" Visible="false"></asp:Label>
                    </td>
                </tr>
                 <!--  Coupon  -->
                 <tr  runat="server" visible="<%#Sellable && HasDiscounts_Coupon_All && Settings_Detail.Discount.ShowCouponInput%>" class="dnnFormItem">
                    <td >
                        <asp:Label ID="lblCoupon" runat="server" resourcekey="lblCoupon"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="txtCoupon" Columns="40"/>
                        <asp:Label ID="lblInvalidCoupon" runat="server" resourcekey="lblInvalidCoupon" CssClass="NormalRed" Visible="false"></asp:Label>
                    </td>
                </tr>
                 <!--  Order Memo  -->
                <tr runat="server" visible="<%#Sellable && Settings_Detail.Order.ShowOrderMemo%>" class="dnnFormItem">
                    <td colspan="2">
                        <asp:Label ID="lblOrderMemo" runat="server" resourcekey="lblOrderMemo"></asp:Label><br />
                        <asp:TextBox runat="server" ID="txtOrderMemo" Columns="70"/>
                    </td>
                </tr>
                <!--  Order buttons  -->
                <tr runat="server" visible="<%# Sellable || Settings_Detail.General.ShowAddWatch || Settings_Detail.General.ShowAddTicket%>">
                    <td colspan="2">
                        ...
                        &nbsp;
                        <dnn:CommandButton ID="btnAddCart" runat="server" ResourceKey="btnAddCart" ImageUrl="~/desktopmodules/crossclassified/images/MyCart.gif"
                            OnCommand="btnAddCart_Click" 
                        ...
                        <dnn:CommandButton ID="btnAddWatch" runat="server" ResourceKey="btnAddWatch" ImageUrl="~/desktopmodules/crossclassified/images/watch.png"
                            OnCommand="btnAddWatch_Click" Visible="<%#Settings_Detail.General.ShowAddWatch%>"
                            CausesValidation="false" />
                        &nbsp;
                                      
                        <dnn:CommandButton ID="btnAddTicket" runat="server" ResourceKey="btnAddTicket" ImageUrl="~/images/action_help.gif"
                            OnCommand="btnAddTicket_Click" Visible="<%#Settings_Detail.General.ShowAddTicket%>"
                            CausesValidation="false" />
                        <br />
                        ...
                        <asp:Label ID="lblHaveSubscriber" runat="server" resourcekey="lblHaveSubscriber"
                            CssClass="NormalRed" Visible="false"></asp:Label>
                        <asp:Label ID="lblHaveItem" runat="server" resourcekey="lblHaveItem"
                            CssClass="NormalRed" Visible="false"></asp:Label>
                        <br />
                    </td>
                </tr>
...
<div id="tabs"  style="width: 100%; overflow:hidden">
    <ul >
        <li runat="server" Visible='<%#objType.FieldEnable_Description && Settings_Detail.General.ShowDescription && !string.IsNullOrEmpty(objProduct.Description.Trim()) && TabCounts>1 %>'>
        <a href="#divDescription"><span><%#Localization.GetString("tabDescription",LocalResourceFile)%></span></a>
        </li>
        
        <li  runat="server" visible='<%#Settings_Detail.General.ShowField1 && objType.EnableField1 && !string.IsNullOrEmpty(objProduct.Field1.Trim()) %>'>
        <a href="#divField1"><span><%#objType.Field1Title%></span></a> 
         </li>
           <li  runat="server" visible='<%#Settings_Detail.General.ShowField2 && objType.EnableField2 && !string.IsNullOrEmpty(objProduct.Field2.Trim()) %>'>
        <a href="#divField2"><span><%#objType.Field2Title%></span></a> 
         </li>
          <li  runat="server" visible='<%#Settings_Detail.General.ShowField3 && objType.EnableField3 && !string.IsNullOrEmpty(objProduct.Field3.Trim()) %>'>
        <a href="#divField3"><span><%#objType.Field3Title%></span></a> 
         </li>
          <li  runat="server" visible='<%#Settings_Detail.General.ShowField4 && objType.EnableField4 && !string.IsNullOrEmpty(objProduct.Field4.Trim()) %>'>
        <a href="#divField4"><span><%#objType.Field4Title%></span></a> 
         </li>
           <li runat="server" visible='<%#Settings_Detail.General.ShowField5 && objType.EnableField5 && !string.IsNullOrEmpty(objProduct.Field5.Trim()) %>'>
        <a href="#divField5"><span><%#objType.Field5Title%></span></a> 
         </li>
      <li  runat="server"  Visible='<%#objType.FieldEnable_SpecialOffer && Settings_Detail.General.ShowSpecialOffer && !string.IsNullOrEmpty(objProduct.SpecialOffer.Trim()) %>'>
        <a href="#divSpecialOffer"><span><%#Localization.GetString("tabSpecialOffer",LocalResourceFile)%></span></a>
        </li>
     <li  runat="server"  Visible='<%#objType.FieldEnable_License && Settings_Detail.General.ShowLicense && !string.IsNullOrEmpty(objProduct.License.Trim()) %>'>
        <a href="#divLicense"><span><%#Localization.GetString("tabLicense",LocalResourceFile)%></span></a>
        </li>
           <li  runat="server"  Visible='<%#objType.FieldEnable_Delivery && Settings_Detail.General.ShowDelivery && !string.IsNullOrEmpty(objProduct.Delivery.Trim()) %>'>
        <a href="#divDelivery"><span><%#Localization.GetString("tabDelivery",LocalResourceFile)%></span></a>
        </li>
           <li  runat="server"  Visible='<%#objType.FieldEnable_Support && Settings_Detail.General.ShowSupport && !string.IsNullOrEmpty(objProduct.Support.Trim()) %>'>
        <a href="#divSupport"><span><%#Localization.GetString("tabSupport",LocalResourceFile)%></span></a>
        </li>
        
       <li   runat="server"  Visible='<%#ShowGoogleMap %>'>
        <a href="#divGoogleMap"><span><%#Localization.GetString("tabGoogleMap",LocalResourceFile)%></span></a>
        </li>
          <li    runat="server"  Visible='<%#HasDiscounts && Sellable && Settings_Detail.Discount.ShowDiscountTab %>'>
        <a href="#divDiscount"><span><%#Localization.GetString("tabDiscount",LocalResourceFile)%></span></a>
        </li>
           <li   runat="server"  Visible='<%#ShowAttachment %>'>
        <a href="#divAttachment"><span><%#Localization.GetString("tabAttachment",LocalResourceFile)%></span></a>
        </li>
           <li runat="server"  Visible='<%#ShowRelatedVideo %>'>
        <a href="#divRelatedVideo"><span><%#Localization.GetString("tabRelatedVideo",LocalResourceFile)%></span></a>
        </li>
          <li   runat="server"  Visible='<%#ShowRelatedAudio %>'>
        <a href="#divRelatedAudio"><span><%#Localization.GetString("tabRelatedAudio",LocalResourceFile)%></span></a>
        </li>
          <li   runat="server"  Visible='<%#ShowRelatedImage %>'>
        <a href="#divRelatedImage"><span><%#Localization.GetString("tabRelatedImage",LocalResourceFile)%></span></a>
        </li>
        
           <li   runat="server"  Visible='<%#ShowTransactionHistory %>'>
        <a href="#divTransactionHistory"><span><%#Localization.GetString("tabTransactionHistory",LocalResourceFile)%></span></a>
        </li>
        
           <li    runat="server"  Visible='<%#Settings_Detail.VendorProfile.ShowVendorProfile%>'>
        <a href="#divAboutAuthor"><span><%#Localization.GetString("tabAboutAuthor",LocalResourceFile)%></span></a>
        </li>
        
       <li runat="server" visible='<%#Settings_Portal.Rating.AllowRating && Settings_Detail.Rating.ShowRating && ( Sellable ||  objProduct.AllowRating )%>'>
            <a href="#divRating"><span>
                <%#Localization.GetString("tabRating",LocalResourceFile)%></span></a> 
         </li>
                
        <li runat="server" visible='<%#Settings_Portal.Comment.AllowComment && objProduct.AllowComment && Settings_Detail.Comment.ShowComment %>'>
            <a href="#divComment"><span>
                <%#Localization.GetString("tabComment",LocalResourceFile)%></span></a> 
        </li>
                
        <li runat="server" visible='<%#ShowRelatedProduct %>'><a  href='#divRelatedProduct'>
            <span>
  ...
  {%>
    ...
    <%} %>
         ...
         <!--  Discount,added in v7.8  -->
    <%if (HasDiscounts && Sellable && Settings_Detail.Discount.ShowDiscountTab)
  {%>
    <div id="divDiscount" style="height: 100%">
       <table cellspacing="2" cellpadding="2" width="100%" class="Normal">
           <tr align="left">
               <td>
                  <%#Server.HtmlDecode(Localization.GetString("Tip_MaxDiscount",LocalResourceFile)) %>
                   <br />
                   <br />

               </td>
           </tr>
           <%if (Settings_Detail.Discount.ShowProductDiscount && HasDiscounts_Product)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_Product) %>
                    <br /> <br />
               </td>
           </tr>
           <%} %>
            <%if (Settings_Detail.Discount.ShowQuantityDiscount && HasDiscounts_Quantity)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_Quantity) %>
                    <br /> <br />
               </td>
           </tr>
           <%} %>

             <%if (Settings_Detail.Discount.ShowCustomerDiscount && HasDiscounts_Customer)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_Customer) %>
                    <br /> <br />
               </td>
           </tr>
           <%} %>

            <%if (Settings_Detail.Discount.ShowRoleDiscount && HasDiscounts_Role)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_Role) %>
                    <br /> <br />
               </td>
           </tr>
           <%} %>

              <%if (Settings_Detail.Discount.ShowCouponDiscount && HasDiscounts_Coupon_Public)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_Coupon) %>
                    <br /> <br />
               </td>
           </tr>
           <%} %>

              <%if (Settings_Detail.Discount.ShowDateDiscount && HasDiscounts_Date)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_Date) %>
                    <br /> <br />
               </td>
           </tr>
           <%} %>

               <%if (Settings_Detail.Discount.ShowFirstBuyerDiscount && HasDiscounts_FirstBuyer)
             {%>
           <tr align="left">
               <td>
                   <%#Server.HtmlDecode(Discounts_FirstBuyer)%>
                    <br /> <br />
               </td>
           </tr>
           <%} %>
                    ...
                    <asp:DataList ID="dlRelatedImage" runat="server" Width="100%" ItemStyle-HorizontalAlign="Left"
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    <td valign="top" align="center">
                                        <asp:HyperLink ID="hlTitle" runat="server" Text='<%# Convert.ToString(Eval("Title")) %>' Target="_blank"
  ...
  {%>
    <div id="divTransactionHistory" style="height: 100%">
        <table cellspacing="2" cellpadding="2" width="100%" class="Normal" visible='false'>
            <tr align="left">
                <td>
                    <asp:GridView ID="grTransactionHistory" runat="server" AutoGenerateColumns="False" Width="100%"
                        CssClass="Normal" CellPadding="1"  CellSpacing="1"  GridLines="Both" BackColor="Gray"  ForeColor="#333333"
                          OnDataBinding="grTransactionHistory_DataBinding">
                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                        <Columns>
                            <asp:TemplateField >
                                <HeaderTemplate>
                                    <asp:Label ID="lblClientNameHead" resourcekey="lblClientNameHead" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField >
                                <HeaderTemplate>
                                    <asp:Label ID="lblProductNameHead" resourcekey="lblProductNameHead" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblProductNameData" runat="server" Text='<%# Convert.ToString(Eval("ProductName")) + (string.IsNullOrEmpty(Convert.ToString(Eval("OptionName")))?string.Empty:" - "+Convert.ToString(Eval("OptionName"))) %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                                <HeaderTemplate>
                                    <asp:Label ID="lblQuantityHead" resourcekey="lblQuantityHead" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblQuantityData" runat="server" Text='<%# Eval("Quantity") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-HorizontalAlign="Right" >
                                <HeaderTemplate>
                                    <asp:Label ID="lblPriceHead" resourcekey="lblPriceHead" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblPriceData" runat="server" Text='<%# Eval("ItemSum") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                                <HeaderTemplate>
            ...
            <tr>
                <td>
                    <Cross:PagingControl ID="ctlTransactionHistory" runat="server" OnPageChanged="ctlTransactionHistory_PageChanged"
  ...
  {%>
    <div id="divAboutAuthor" style="height: 100%">
        <table cellspacing="2" cellpadding="2" width="100%" class="Normal">
            <!--    Company -->
            <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowCompany && !string.IsNullOrEmpty(objAuthor.Company)%>">
              ...
              <!--    country-->
                 <tr   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowCountry && !string.IsNullOrEmpty(objAuthor.Country)%>">
                    <td style="width:150px">
                  ...
                  <!--    State-->
                 <tr   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowState && !string.IsNullOrEmpty(objAuthor.State)%>">
                    <td style="width:150px">
                  ...
                  <!--    City-->
                 <tr   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowCity && !string.IsNullOrEmpty(objAuthor.City)%>">
                    <td style="width:150px">
               ...
               <!--    Town-->
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowTown && !string.IsNullOrEmpty(objAuthor.Town)%>">
                    <td style="width:150px">
                  ...
                  <!--    Tel-->
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowTel && !string.IsNullOrEmpty(objAuthor.Tel)%>">
                    <td style="width:150px">
                  ...
                  <!--    Fax-->
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowFax && !string.IsNullOrEmpty(objAuthor.Fax)%>">
                    <td style="width:150px">
           ...
           <!--    Zipcode-->
                 <tr   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowZipcode && !string.IsNullOrEmpty(objAuthor.Zipcode)%>">
                    <td style="width:150px">
                 ...
                 <!--    IM-->
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowIM && !string.IsNullOrEmpty(objAuthor.IM)%>">
                    <td style="width:150px">
                ...
                <!--    Linkman-->
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowLinkman && !string.IsNullOrEmpty(objAuthor.Linkman)%>">
                    <td style="width:150px">
                ...
                <!--    Address-->
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowAddress && !string.IsNullOrEmpty(objAuthor.Address)%>">
                    <td style="width:150px">
                 ...
                 <!--    BusinessScope-->
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowBusinessScope && !string.IsNullOrEmpty(objAuthor.BusinessScope)%>">
                    <td style="width:150px">
                 ...
                 <!--    SiteUrl-->
            <tr runat="server" visible='<%#Settings_Detail.VendorProfile.ShowSiteUrl 
            && !string.IsNullOrEmpty(objAuthor.SiteUrl) && objAuthor.SiteUrl.StartsWith("http")%>'>
                ...
                <!--    LogoUrl-->
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowLogoUrl && !string.IsNullOrEmpty(objAuthor.LogoUrl)%>">
                    <td style="width:150px">
                  ...
                  <!--    Slogan-->
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowSlogan && !string.IsNullOrEmpty(objAuthor.Slogan)%>">
                    <td style="width:150px">
                 ...
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField1 
                 ...
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField2 
                 ...
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField3 
                 ...
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField4 
                 ...
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField5 
                 ...
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField6 
                 ...
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField7 
                 ...
                 <tr  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField8 
                 ...
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField9 
                 ...
                 <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField10 
               ...
               <tr runat="server" visible="<%#Settings_Detail.VendorProfile.ShowBiography  && !string.IsNullOrEmpty(objAuthor.Biography)%>">
                <td colspan="2">
                   <br />
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="left">
                                        ...
                                        <asp:Image ID="imgRating" runat="server" ImageUrl='<%#GetRatingImage(Convert.ToString(Eval("Id"))) %>'
                                            ImageAlign="Left" /><br />
                                        <asp:Label ID="PriceLabel" runat="server" Text='<%#Server.HtmlDecode(Convert.ToString(Eval("CurrentPrice"))) %>' /><br />
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
