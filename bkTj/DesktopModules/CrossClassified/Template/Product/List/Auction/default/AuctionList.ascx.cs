...
{
    public partial class AuctionList : CPModuleBase
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LocalResourceFile = Localization.GetResourceFile(this, "AuctionList.ascx");
        ...
        private List<ProductInfo> GetProducts_None(int pageIndex, ref int pageSize, ref int totalRecords)
        {
          ...
          , pageSize, Settings_List.Paging.ShowPage, cultureCode, pageSize, pageIndex, ref totalRecords);
    ...
    && Request.Form["S_UDT" + i.ToString() + "_Oper"] != null
     && Utils.IsNumber(Request.Form["S_UDT" + i.ToString() + "_ID"]))
                ...
                if (Request.Form["S_Price_Oper"] != null)
                {
                    ...
                    switch (oper.ToLower())
                    {
                        case "between":
                            ...
                            {
                                if (objProduct.StartPrice < decimal.Parse(Request.Form["S_Price_From"].ToString())
                                    || objProduct.StartPrice > decimal.Parse(Request.Form["S_Price_To"].ToString()))
                                {
                                    continue;
                                }
                            }
                        ...
                        case "lessthan":
                            if (Request.Form["S_Price"] != null
                                ...
                                && objProduct.StartPrice >= decimal.Parse(Request.Form["S_Price"].ToString()))
                            {
                                continue;
                            }
                            break;
        ...
        protected void grProduct_DataBinding(object sender, EventArgs e)
        {
            ...
            if (grProduct.Columns[12] != null)//StartPrice
            {
                grProduct.Columns[12].Visible = Settings_List.Content.ShowStartPrice;
            }
            if (grProduct.Columns[13] != null)//BuyNowPrice
            {
                grProduct.Columns[13].Visible = Settings_List.Content.ShowBuyNowPrice && !IsSecondItemAuction;
            }
            if (grProduct.Columns[14] != null)//CurrentBid
            {
                grProduct.Columns[14].Visible = Settings_List.Content.ShowCurrentBid && IsEnglishAuction;
            }
            if (grProduct.Columns[15] != null)//CurrentBidder
            {
                grProduct.Columns[15].Visible = Settings_List.Content.ShowCurrentBidder && IsEnglishAuction;
            }
            if (grProduct.Columns[16] != null)//BidCount
            {
                grProduct.Columns[16].Visible = Settings_List.Content.ShowBidCount;
            }

            if (grProduct.Columns[17] != null)//PublishDate
            {
                grProduct.Columns[17].Visible = Settings_List.Content.ShowPublishDate;
            }

            if (grProduct.Columns[18] != null)//ExpireDate
            {
                grProduct.Columns[18].Visible = Settings_List.Content.ShowExpireDate;
            }

            if (grProduct.Columns[19] != null)//RemainTime
            {
                grProduct.Columns[19].Visible = Settings_List.Content.ShowRemainTime;
            }

            if (grProduct.Columns[20] != null)//FeaturedField
            {
                grProduct.Columns[20].Visible = Settings_List.Content.ShowFeaturedField;
            }

            if (grProduct.Columns[21] != null)//Summary
            {
                grProduct.Columns[21].Visible = Settings_List.Content.ShowSummary && CurrentType.FieldEnable_Summary;
            }

            if (grProduct.Columns[22] != null)//bid now button
            {
                grProduct.Columns[22].Visible = Settings_List.Content.ShowBidButton;
            }
        }
