...
.prolist .borderbox{ -webkit-transition:all 0.5s ease; -moz-transition:all 0.5s ease; -o-transition:all 0.5s ease;transition:all 0.5s ease; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; background:#fff;box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.1); -moz-box-shadow:0px 0px 4px rgba(0, 0, 0, 0.1); -webkit-box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.1); overflow:hidden }
.prolist .borderbox .imgbox{ height:270px; border-bottom:1px #eee solid; overflow:hidden; line-height:270px; width:100%; text-align:center; margin-bottom:15px}
.prolist .borderbox:hover{ box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3); -moz-box-shadow:0px 0px 8px rgba(0, 0, 0, 0.3); -webkit-box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.3);;}
.prolist .borderbox .imgbox a { display:inline-block; vertical-align:middle;}
.prolist .borderbox .imgbox a img{ max-width:100%; max-height:100%; vertical-align:middle;-webkit-transition: all 0.4s ease-in-out;-moz-transition: all 0.4s ease-in-out;-o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;}
.prolist .borderbox .infobox{ padding:0 15px; margin-bottom:15px;}
.prolist .borderbox .infobox p{ border-bottom:1px #f8f8f8 solid; margin:0px; padding:5px 0}
.prolist .borderbox .infobox p:last-child{ border-bottom:0px #f5f5f5 solid;}
.prolist li{ margin:0px; padding:0px; list-style:none;position:relative; overflow:hidden}
.col3:after,.col4:after,.col5:after{ display:block; content:''; clear:both}
.prolist .col3 li{ width:31.33333%; float:left; margin:0 1% 20px 1%;}
.prolist .col4 li{ width:23%; float:left; margin:0 1% 20px 1%;}
.prolist .col5 li{ width:18%; float:left; margin:0 1% 20px 1%;}
.prolist li .minfo {
	top: auto;
	bottom: 0;
	...
	transform: translate3d(0,100%,0); position:absolute; width:100%; text-align:center; line-height:60px;
}
.prolist li .minfo span.CommandButton{-webkit-transition:all 0.5s ease; -moz-transition:all 0.5s ease; -o-transition:all 0.5s ease;transition:all 0.5s ease; -webkit-border-radius: 40px; -moz-border-radius: 40px; border-radius: 40px; background:#fff;box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.1); -moz-box-shadow:0px 0px 4px rgba(0, 0, 0, 0.1); -webkit-box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.1); padding:10px 20px; background:#F4AE01;}
.prolist li .minfo span.CommandButton a{ color:#fff}
.prolist li .minfo span.CommandButton:nth-child(2){ background:#79BE27 }
.prolist li .minfo span.CommandButton:hover{ background:#E43137}
.prolist li .minfo input{ display:none}
.prolist li:hover .minfo
{
...
.prolist .col5 li{ width:31.333%}
.prolist .col3 li,.prolist .col4 li{ width:48%}
}
@media handheld, only screen and (max-width: 767px) { 
.prolist .col5 li{ width:48%}
}
@media handheld, only screen and (max-width: 480px) { 
.prolist .borderbox .imgbox{ height:160px;line-height:160px;}
}
...
<div class="prolist">
    <ul class="col<%#Settings_List.Paging.ColCount %>">
        <asp:Repeater ID="dlProduct" runat="server" OnItemCommand="dlProduct_ItemCommand">
            <ItemTemplate>
                 <li><div class="borderbox">
                         <div class="imgbox">   
                                ...
                                <asp:HyperLink ID="hlImage" runat="server" 
                                    ...
                                    <%if (Settings_List.Image.ForceImageWidth && Settings_List.Image.ForceImageHeight)
                                      { %>
                                    <asp:Image runat="server" ImageUrl='<%#Eval("Thumbnail")%>' ID='imgProduct' />
                                    <%}
                                      else if (Settings_List.Image.ForceImageWidth)
                                      {%>
                                    <asp:Image runat="server" ImageUrl='<%#Eval("Thumbnail")%>' ID='Image1' />
                                    <%}
                                      else if (Settings_List.Image.ForceImageHeight)
                                      {%>
                                    <asp:Image runat="server" ImageUrl='<%#Eval("Thumbnail")%>' ID='Image2' />
                                    <% }
                                      else
                                      {%>
                                    <asp:Image runat="server" ImageUrl='<%#Eval("Thumbnail")%>' ID='Image3' />
                                    <%} %>
                                </asp:HyperLink>
                                 <%} %></div>
                                <div class="infobox">
                                    <strong><asp:HyperLink ID="hlName" runat="server" Visible="<%#Settings_List.Content.ShowName %>"
                                    ...
                                    <p><asp:Image ID="imgRating" runat="server" Visible="<%#Settings_List.Content.ShowRating %>" ImageUrl='<%#GetRatingImage(Convert.ToString(Eval("Id"))) %>' />
									<span style="float:right"><asp:Label ID="PurchasePriceLabel" runat="server" Text='<%#Settings_Portal.Order.CurrencySymbol+ Convert.ToString(Eval("PurchasePrice")) %>' CssClass='<%# GetPriceCss(Convert.ToString(Eval("Id"))) %>' />
									<asp:Label ID="PromoPriceLabel" runat="server" Text='<%#Settings_Portal.Order.CurrencySymbol+Convert.ToString(Eval("PromoPrice")) %>' CssClass='NormalRed' Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id"))) %>' /></span></p>
                                    <p><asp:Label ID="lblViews" runat="server" resourcekey="lblViews" Visible="<%#Settings_List.Content.ShowViews %>" /> <asp:Label ID="ViewsLabel" runat="server" Text='<%# Eval("Views") %>' Visible="<%#Settings_List.Content.ShowViews %>" /></p>
                                                 
                                </div>
                       <div class="infobox">
                                    <strong>View Demo:<asp:HyperLink ID="hlViewDemo" runat="server"  Text='<%#GetUDFieldValue("ViewDemo",Convert.ToString(Eval("Id"))) %>'
                                     NavigateUrl='<%#GetUDFieldValue("ViewDemo",Convert.ToString(Eval("Id"))) %>'
                                    Target="<%#Settings_List.General.LinkTarget%>" />
                                    </strong>
                                  
                                </div>
								<div class="minfo"><%if ((Settings_List.Content.ShowOrderNow || Settings_List.Content.ShowAddCart))
                                      { %>
