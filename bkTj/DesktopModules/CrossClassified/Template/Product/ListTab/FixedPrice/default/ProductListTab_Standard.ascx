<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductListTab.ascx.cs"
    Inherits="Cross.Modules.CP_Product.View.ProductListTab" %>
...
<div id="divTabs" runat="server" style="width: 100%; overflow: hidden">
    ...
    <div id="divTab1" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct1" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
                    ...
                    <tr>
                        <td align="left" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                ...
                                <%} %>
                                <%if (Settings_ListTab.Content.ShowPackageFee && CurrentType.FieldEnable_PackageFee)
                                  { %>
                                <tr>
                                    <td>
                                ...
                                <%} %>
                                <%if (Settings_ListTab.Content.ShowPrice)
                                  { %>
                                <tr>
                                    <td>
    ...
    <div id="divTab2" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct2" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
    ...
    <div id="divTab3" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct3" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
    ...
    <div id="divTab4" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct4" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
    ...
    <div id="divTab5" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct5" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
    ...
    <div id="divTab6" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct6" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
    ...
    <div id="divTab7" runat="server"  style="height: 100%">
        <asp:DataList ID="dlProduct7" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
    ...
    <div id="divTab8" runat="server" style="height: 100%">
        <asp:DataList ID="dlProduct8" runat="server" CssClass="Normal" RepeatColumns="<%#Settings_ListTab.General.ColCount %>"
            RepeatDirection="Horizontal" RepeatLayout="table" Width="100%" 
