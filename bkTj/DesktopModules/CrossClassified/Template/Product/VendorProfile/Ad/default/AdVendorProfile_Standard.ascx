<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdVendorProfile.ascx.cs" Inherits="Cross.Modules.CP_Product.View.AdVendorProfile" %>
...
<asp:Table ID="tblAdvancedSearchCondition" runat="server" Width="100%" CssClass="dnnFormItem"
    ...
    <asp:TableRow ID="trBuiltInField_Town" runat="server" Visible="false">
        ...
        <asp:TableCell>
            <asp:DropDownList ID="ddlBuiltInField_Town" runat="server" Width="<%#Convert.ToInt32(Settings_VendorProfile.Product_Search_Advanced.Width_Input)%>">
            </asp:DropDownList>
        </asp:TableCell>
    </asp:TableRow>
</asp:Table>
...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr valign="top">
        <td valign="top" align="left">
            ...
            <asp:DataList ID="dlProduct" runat="server"  RepeatColumns="<%#Settings_VendorProfile.Product_Paging.ColCount %>" CssClass="Normal"
                        ...
                        <tr align="left">
                            <td>
                                ...
                                <asp:HyperLink ID="hlImage" runat="server" NavigateUrl='<%# GetNavigate(Convert.ToString(Eval("Id")), Convert.ToString(Eval("Name")))%>'
                                    Target="<%#Settings_VendorProfile.General.LinkTarget%>"  CssClass="<%#GetFancyBoxClass()%>" data-fancybox-group="<%#GetFancyBoxGroup()%>"
                                    ...
                                    <asp:Image runat="server" ImageUrl='<%#Eval("Thumbnail")%>' Width='<%#Convert.ToInt32(Settings_VendorProfile.Product_Image.ImageWidth)%>'
                                        Height='<%#Convert.ToInt32(Settings_VendorProfile.Product_Image.ImageHeight)%>' BorderStyle="Solid"
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                    <tr>
                                        <td>
                                            <%if (Settings_VendorProfile.Product_Image.UseLightBoxEffect && Settings_VendorProfile.Product_Image.ShowImage)
                                                { %>
                                            <asp:Label ID="lblProductName" runat="server" Text='<%# Server.HtmlDecode(Convert.ToString(Eval("Name"))) %>'
                                                Visible="<%#Settings_VendorProfile.Product_Content.ShowName %>" />
                                            <% }
                                                else
                                                {%>
                                            <asp:HyperLink ID="hlName" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowName %>"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblViews" runat="server" resourcekey="lblViews" Visible="<%#Settings_VendorProfile.Product_Content.ShowViews %>" />
                                    ...
                                    <%} %>
                                    <%if (Settings_VendorProfile.Product_Content.ShowPrice && CurrentType.FieldEnable_Price)
                                      { %>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblPromoStart" runat="server" resourcekey="lblPromoStart" Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id")))&&Settings_VendorProfile.Product_Content.ShowPromoStart %>' />
                                            <asp:Label ID="PromoStartLabel" runat="server" Text='<%# Convert.ToDateTime(Eval("PromoStart"))==DotNetNuke.Common.Utilities.Null.NullDate?"":Convert.ToDateTime(Eval("PromoStart")).ToShortDateString() %>'
                                                Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id")))&&Settings_VendorProfile.Product_Content.ShowPromoStart %>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblPromoEnd" runat="server" resourcekey="lblPromoEnd" Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id")))&&Settings_VendorProfile.Product_Content.ShowPromoEnd %>' />
                                            <asp:Label ID="PromoEndLabel" runat="server" Text='<%# Convert.ToDateTime(Eval("PromoEnd"))==DotNetNuke.Common.Utilities.Null.NullDate?"":Convert.ToDateTime(Eval("PromoEnd")).ToShortDateString() %>'
                                                Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id")))&&Settings_VendorProfile.Product_Content.ShowPromoEnd %>' />
                                        </td>
                                    </tr>
                                    <%} %>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCreatedDate" runat="server" resourcekey="lblCreatedDate" Visible="<%#Settings_VendorProfile.Product_Content.ShowCreatedDate%>" />
                                            <asp:Label ID="CreatedDateLabel" runat="server" Text='<%# Convert.ToDateTime( Eval("CreatedDate")).ToShortDateString() %>'
                                                Visible="<%#Settings_VendorProfile.Product_Content.ShowCreatedDate %>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblFeatured" runat="server" resourcekey="lblFeatured" Visible="<%#Settings_VendorProfile.Product_Content.ShowFeaturedField %>" />
            ...
            <asp:GridView ID="grProduct" runat="server" AutoGenerateColumns="False" Visible="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblRating" resourcekey="lblRating1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowRating %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Image ID="imgRating" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowRating %>"
                                ImageUrl='<%#GetRatingImage(Convert.ToString(Eval("Id"))) %>' />
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblViews" resourcekey="lblViews1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowViews %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="ViewsLabel" runat="server" Text='<%# Eval("Views") %>' Visible="<%#Settings_VendorProfile.Product_Content.ShowViews %>" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblSku" resourcekey="lblSku1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowSku %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblWeight" resourcekey="lblWeight1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowWeight %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblSellPrice" resourcekey="lblPurchasePrice1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowPrice %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="PurchasePriceLabel" runat="server" Text='<%#Settings_Portal.Order.CurrencySymbol+Convert.ToString(Eval("PurchasePrice")) %>'
                                CssClass='<%# GetPriceCss(Convert.ToString(Eval("Id"))) %>' />&nbsp;&nbsp;
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblPromoStart" resourcekey="lblPromoStart1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowPromoStart %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="PromoStartLabel" runat="server" Text='<%# Convert.ToDateTime(Eval("PromoStart"))==DotNetNuke.Common.Utilities.Null.NullDate?"":Convert.ToDateTime(Eval("PromoStart")).ToShortDateString() %>'
                                Visible='<%#Settings_VendorProfile.Product_Content.ShowPromoStart %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblPromoEnd" resourcekey="lblPromoEnd1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowPromoEnd %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="PromoEndLabel" runat="server" Text='<%# Convert.ToDateTime(Eval("PromoEnd"))==DotNetNuke.Common.Utilities.Null.NullDate?"":Convert.ToDateTime(Eval("PromoEnd")).ToShortDateString() %>'
                                Visible="<%#Settings_VendorProfile.Product_Content.ShowPromoEnd %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblCreatedDate" resourcekey="lblCreatedDate1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowCreatedDate %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="CreatedDateLabel" runat="server" Text='<%# Convert.ToDateTime( Eval("CreatedDate")).ToShortDateString() %>'
                                Visible="<%#Settings_VendorProfile.Product_Content.ShowCreatedDate %>" />
