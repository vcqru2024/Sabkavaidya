<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductVendorProfile.ascx.cs" Inherits="Cross.Modules.CP_Product.View.ProductVendorProfile" %>
...
<table width="100%" cellpadding="0" cellspacing="0" id="tblVendorProfile" runat="server"
    ...
    <tr>
        ...
        <td colspan="2">
            ...
            <!-- user name-->
            <asp:Label ID="lblUserName" runat="server" Text="<%#objAuthor.Username%>"
                />
        </td>
    </tr>
    <!--    Company -->
    ...
    <tr runat="server" visible='<%#Settings_VendorProfile.Profile.ShowSiteUrl 
            && !string.IsNullOrEmpty(objAuthor.SiteUrl) && objAuthor.SiteUrl.ToLower().StartsWith("http")%>'>
        <td style="width: 150px">
    ...
    <tr valign="top">
        <td valign="top" align="left" >
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                    ...
                                    <%if (Settings_VendorProfile.Product_Content.ShowPackageFee && CurrentType.FieldEnable_PackageFee)
                                        { %>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Label ID="PromoEndLabel" runat="server" Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id"))) && Settings_VendorProfile.Product_Content.ShowPromoEnd %>'
                                    ...
                                    <%if (Settings_VendorProfile.Product_Content.ShowCreatedDate)
                                        { %>
                                    <tr>
                                        <td>
                                    ...
                                    <%if (Settings_VendorProfile.Product_Content.ShowSummary && CurrentType.FieldEnable_Summary)
                                        { %>
                                    <tr>
                                        <td>&nbsp;&nbsp;<asp:Label ID="SummaryLabel" runat="server" Text='<%# GetShortenSummary(Convert.ToString(Eval("Id")), Convert.ToString(Eval("Summary"))) %>' />
                                        </td>
                                    </tr>
                                    <%} %>
            ...
            <asp:GridView ID="grProduct" runat="server" AutoGenerateColumns="False" Visible="False" Width="100%"
                ...
                DataKeyNames="Id" OnDataBinding="grProduct_DataBinding" >
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblPackageFee" resourcekey="lblPackageFee1" runat="server" Visible="<%#Settings_VendorProfile.Product_Content.ShowPackageFee %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="PackageFeeLabel" runat="server" Text='<%# Eval("PackageFee") %>' Visible="<%#Settings_VendorProfile.Product_Content.ShowPackageFee %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
