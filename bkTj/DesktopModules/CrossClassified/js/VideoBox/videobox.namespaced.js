var Videobox = {
    ...
    video: function (sLinkHref) {
       ...
       || sLinkHref.match(/\.mp4/i) || sLinkHref.match(/\.m4v/i)
       || sLinkHref.match(/\.f4v/i) || sLinkHref.match(/\.mp3/i)
       || sLinkHref.match(/\.aac/i) || sLinkHref.match(/\.m4a/i)
       || sLinkHref.match(/\.f4a/i)) {
            this.flash = true;
