...
namespace Saatvik.ModulesDieseas
{
    ...
    /// 
    /// Because the control inherits from DieseasSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : DieseasModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                ...
                {
                    if (Settings.Contains("showActivatedDisease"))
                    {
                        ShowCompletedTasksSelector.SelectedValue = Settings["showActivatedDisease"].ToString();
                    }
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                modules.UpdateModuleSetting(ModuleId, "showActivatedDisease", ShowCompletedTasksSelector.SelectedValue);
