        ...
        <ContentTemplate>
            ...
            <asp:MultiView ID="ContentMultiView" runat="server">
                <asp:View ID="ListView" runat="server">
                    <h2><%= LocalizeString("DistributorsHeader") %></h2>
                    <div class="rvdsfListContainer">
                        <div class="row rvdsf-actionbar-container">
                            ...
                            <div class="col-sm-6 text-sm-right">
                                 <asp:HyperLink  ID="AddHyperLink" resourcekey="AddHyperLink" runat="server"  CssClass="btn btn-primary rvdAddNewAction" onclick="dnn.dom.deleteCookie('dnnTabs-DistributorDetailsViewTabPanel', '/')" />
                            </div>
                        </div>
                        <asp:GridView ID="DistributorGridView" runat="server" CssClass="table table-striped table-hover" GridLines="None" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DistributorID" AllowPaging="True" OnRowDeleting="DistributorGridView_RowDeleting" OnRowDataBound="DistributorGridView_RowDataBound">
                ...
                <asp:View ID="DetailsView" runat="server">
                    ...
                    <h2><%= LocalizeString("DistributorHeader") %>: <uc1:BreadcrumbControl ID="BreadcrumbControl" runat="server" /><asp:Label ID="DistributorIDLabel" runat="server" CssClass="badge badge-secondary rvdsf-badge-small"></asp:Label></h2>
                    <div class="row rvdsf-actionbar-container">
                        <div class="col-sm-6">
                    ...
                    <div id="DistributorDetailsViewTabPanel" >
                            ...
                            <fieldset>
                                <div ID="GeneralDetailsViewSubPanel">
								    <asp:Panel ID="DistributorKeyPanel" runat="server" CssClass="dnnFormItem">
									    <dnn1:LabelControl ID="DistributorKeyLabelControl" runat="server" CssClass="dnnFormRequired" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="DistributorKeyTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="[^;|\[\]&lt;&gt;{}^\\]+" ValidationGroup="DetailsViewControl"><%= Localization.GetString(Global.LocalizedStrings.Message_FieldRequiredError, Global.FilePaths.LocalSharedResourceFile) %></asp:RegularExpressionValidator>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="dnnFormItem">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="MetaDescriptionTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ErrorMessage="*" ValidationExpression="^[\s\S]{0,400}$" ValidationGroup="DetailsViewControl"><%= Localization.GetString(Global.LocalizedStrings.Message_FieldRequiredError, Global.FilePaths.LocalSharedResourceFile) %></asp:RegularExpressionValidator>
