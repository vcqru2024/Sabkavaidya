<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentTermAvailabilityRuleControl.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.PaymentTermAvailabilityRuleControl" %>
...
<asp:MultiView ID="FormulaMultiView" runat="server" ActiveViewIndex="0">
	...
	<asp:View ID="CustomRuleView" runat="server">
		<div class="dnnFormItem">
			...
			<uc1:FormulaEditorControl ID="AvailabilityRuleFormulaEditor" runat="server" Width="100%" ModuleControl="PaymentTermAvailability" />
		</div>
	</asp:View>
</asp:MultiView>
