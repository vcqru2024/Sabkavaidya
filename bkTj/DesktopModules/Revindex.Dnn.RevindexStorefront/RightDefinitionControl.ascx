        ...
        <ContentTemplate>
            ...
            <asp:MultiView ID="ContentMultiView" runat="server">
                <asp:View ID="ListView" runat="server">
                    <h2><%= LocalizeString("RightDefinitionsHeader") %></h2>
                    ...
                    <div class="rvdsfListContainer">
                        <asp:GridView ID="RightDefinitionGridView" runat="server" CssClass="table table-striped table-hover" GridLines="None" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="RightDefinitionID" OnRowDeleting="RightDefinitionGridView_RowDeleting" OnRowDataBound="RightDefinitionGridView_RowDataBound">
                ...
                <asp:View ID="DetailsView" runat="server">
                    ...
                    <h2><%= LocalizeString("RightDefinitionHeader") %>: <uc1:BreadcrumbControl ID="BreadcrumbControl" runat="server" /><asp:Label runat="server" ID="RightDefinitionIDLabel" CssClass="badge badge-secondary rvdsf-badge-small"></asp:Label></h2>
                    <hr />
                    <div>
                        <fieldset>
							...
							<div class="dnnFormItem">
                                <dnn1:LabelControl ID="RightTypeLabelControl" runat="server" />
                                <asp:DropDownList ID="RightTypeDropDownList" runat="server">
									<asp:ListItem resourcekey="PreLabel" Value="1" />
								</asp:DropDownList>
                            </div>
                        </fieldset>
                    </div>
