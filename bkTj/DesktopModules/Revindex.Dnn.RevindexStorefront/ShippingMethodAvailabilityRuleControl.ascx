...
<asp:MultiView ID="FormulaMultiView" runat="server" ActiveViewIndex="0">
	<asp:View ID="BasicAvailabilityView" runat="server">
		...
		<div class="dnnFormItem">
			...
			<asp:CompareValidator ID="MaxOrderQuantityBasicAvailabilityCompareValidator" runat="server" ControlToValidate="MaxOrderQuantityBasicAvailabilityTextBox" CssClass="dnnFormMessage dnnFormError" Operator="DataTypeCheck" Type="Integer" Display="Dynamic" ValidationGroup="DetailsViewControl"><%= Localization.GetString(Global.LocalizedStrings.Message_FieldRequiredError, Global.FilePaths.LocalSharedResourceFile) %></asp:CompareValidator>
			<asp:TextBox ID="MaxOrderQuantityBasicAvailabilityTextBox" runat="server" value="" TextMode="Number"></asp:TextBox>
		</div>
		<div class="dnnFormItem">
			...
			<div class="rvdFormSubContainer">
				...
				<asp:TextBox ID="MinOrderWeightBasicAvailabilityTextBox" runat="server" value="" CssClass="rvd-form-number" ></asp:TextBox>
				...
				<asp:GridView ID="RegionBasicAvailabilityGridView" runat="server" CssClass="table table-striped table-hover" GridLines="None" AutoGenerateColumns="False" DataKeyNames="CountryCode,SubdivisionCode,PostalCode" OnRowDeleting="RegionBasicAvailabilityGridView_RowDeleting" OnSelectedIndexChanged="RegionBasicAvailabilityGridView_SelectedIndexChanged" OnRowDataBound="RegionBasicAvailabilityGridView_RowDataBound">
					...
					<Columns>
						<asp:TemplateField HeaderText="Country">
							<ItemTemplate>
								<asp:LinkButton ID="SelectLinkButton" runat="server" CommandName="Select" Text='<%# Eval("Country") %>' OnClientClick="event.stopPropagation()" ></asp:LinkButton>
							</ItemTemplate>
						</asp:TemplateField>
