<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SimilarProductControl.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.SimilarProductControl" %>
                ...
                <fieldset>
                    <div class="dnnFormItem">
                        ...
                        <div class="rvdFormSubContainer">
                            ...
                            <asp:CheckBox ID="BidirectionalAddCheckBox" runat="server" resourcekey="BidirectionalAddCheckBox" Checked="true" />
