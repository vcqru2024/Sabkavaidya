		...
		<ContentTemplate>
			<asp:Panel runat="server" ID="FormulaEditorPanel" CssClass="rvdsfFormFormulaEditor">
				...
				<ul data-role="menu" >
					...
					<li><asp:LinkButton ID="RunTestLinkButton" runat="server" OnClick="RunTestLinkButton_Click"><em class="glyphicon glyphicon-play fa fas fa-play"></em><span class="hidden-xs d-none d-sm-inline"> <%= LocalizeString("RunTestLabel") %></span></asp:LinkButton></li>
					<li>
						...
						<ul>
							...
							<li><a href="https://www.w3schools.com/xml/xsl_intro.asp" target="_blank">XSLT tutorial</a></li>
							<li><a href="https://www.revindex.com/Support/Forum" target="_blank" >Revindex forum</a></li>
						</ul>
					</li>
				</ul>
				<asp:Panel ID="FormulaEditorTabPanel" runat="server">
                    <ul style="padding-top: 10px; background-color: #f5f5f5; border-right: solid 1px #ccc; border-left: solid 1px #ccc;">
                        <li>
                            <%= LocalizeString("InputLabel") %>
                        </li>
                        <li>
                            <%= LocalizeString("RuleLabel") %>
                        </li>
                        <li>
                            <%= LocalizeString("OutputLabel") %>
                        </li>
                    </ul>
                    <div>
						<asp:TextBox ID="SampleInputTextBox" runat="server" TextMode="MultiLine" Rows="26" Width="100%" Wrap="False" ></asp:TextBox>                        
                    </div>
                    <div>
                        <asp:TextBox ID="RuleTextBox" runat="server" TextMode="MultiLine" Rows="26" Width="100%" Wrap="False" ></asp:TextBox>
                    </div>
                    <div>
                        <asp:TextBox ID="OutputTextBox" runat="server" TextMode="MultiLine" Rows="26" Width="100%" Wrap="False" ></asp:TextBox>
                    </div>
                </asp:Panel>
				<asp:HiddenField ID="SelectedTabHiddenField" runat="server" value="1" />			
			</asp:Panel>
		</ContentTemplate>
	</asp:UpdatePanel>
</div>