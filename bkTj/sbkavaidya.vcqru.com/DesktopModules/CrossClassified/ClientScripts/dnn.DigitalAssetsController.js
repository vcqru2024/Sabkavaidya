...
dnnModule.DigitalAssetsController.prototype = function () {
    ...
    var getContentServiceUrl = function () {
            return this.servicesFramework.getServiceRoot('CrossDigitalAssets') + 'ContentService/';
        },
        getDownloadServiceUrl = function () {
            return this.servicesFramework.getServiceRoot('CrossDigitalAssets') + 'DownloadService/';
        },
