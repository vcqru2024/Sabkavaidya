    ...
    <tr>
        ...
        <td valign="top" align="left">
            <table id="Table1" cellspacing="2" cellpadding="2" width="100%"  align="left" runat="server">
                ...
                <!--    PackageFee -->
                  <tr id="Tr4" runat="server" visible="<%#Settings_Detail.Order.ShowPackageFee && objType.FieldEnable_PackageFee%>">
                    <td>
                  ...
                  <!--    views -->
                <tr id="Tr5" runat="server" visible="<%#Settings_Detail.General.ShowViews%>">
                    <td>
               ...
               <!--    PublishDate, normally don't need in fixed price product -->
                 <tr id="Tr7" runat="server" visible="<%#Settings_Detail.General.ShowPublishDate%>">
                    <td>
                 ...
                 <tr id="Tr8"  runat="server" visible="<%#Settings_Detail.General.ShowExpireDate%>">
                    <td>
                 ...
                 <!--    Last Modified Date -->
                 <tr id="Tr9"  runat="server" visible="<%#Settings_Detail.General.ShowLastModifiedDate%>">
                    <td>
                ...
                <!--   summary -->
                    <tr id="Tr10" valign="top" runat="server" visible="<%#Settings_Detail.General.ShowSummary && objType.FieldEnable_Summary%>">
                    <td colspan="2">
                        &nbsp;&nbsp;<%#Server.HtmlDecode(objProduct.Summary) %>
                    </td>
                </tr>
                  <!--  tags  -->
                <tr id="Tr11" runat="server" visible="<%#Settings_Detail.Tag.ShowTags %>">
                    <td>
                ...
                <tr>
                  ...
                  <!--  purchase price  -->
                <tr id="Tr12" runat="server" visible="<%#Settings_Detail.Order.ShowPrice && objType.FieldEnable_Price%>">
                    <td>
                  ...
                  <!--  promo price  -->
                <tr id="Tr13" runat="server" visible='<%#objProduct.PromoPriceAvailable && Settings_Detail.Order.ShowPrice && objType.FieldEnable_Price %>'>
                    <td>
                ...
                <!--  promo start  -->
                <tr id="Tr14" runat="server" visible='<%#objProduct.PromoPriceAvailable && Settings_Detail.Order.ShowPrice && Settings_Detail.Order.ShowPromoStart && objType.FieldEnable_Price %>'>
                    <td>
                 ...
                 <!--  promo end  -->
                <tr id="Tr15" runat="server" visible='<%#objProduct.PromoPriceAvailable && Settings_Detail.Order.ShowPrice && Settings_Detail.Order.ShowPromoEnd&&objType.FieldEnable_Price %>'>
                    <td>
                   ...
                   <!--  shipping options  -->
                <tr id="Tr22" runat="server" visible='<%# objType.SellType == Convert.ToInt16(Cross.Modules.CP_Product.Business.SellType.Goods) && Settings_Detail.Order.ShowOrderShippingOption %>'>
                    <td>
                ...
                <tr>
                 ...
                 <!--  Stock Quantity   -->
                <tr id="Tr16" runat="server" visible="<%#Settings_Detail.Order.ShowStockQuantity && objProduct.StockQuantity!=-1 && objType.FieldEnable_StockQuantity%>">
                    <td>
                ...
                <!--  options   -->
                <tr id="Tr17" valign="top" runat="server" visible="<%#ShowOptionList%>" >
                ...
                <tr id="trVaraint_5" runat="server" visible="<%#HasVariant_5%>" class="dnnFormItem">
                 ...
                 <!--  Order Count   -->
                <tr id="Tr18" runat="server" visible="<%#Sellable && Settings_Detail.Order.ShowOrderCount%>" class="dnnFormItem">
                    <td >
                ...
                runat="server" ValidationExpression="\d*" ControlToValidate="txtOrderCount"></asp:RegularExpressionValidator>
                 ...
                 <!--  Coupon  -->
                 <tr id="Tr19"  runat="server" visible="<%#Sellable && HasDiscounts_Coupon_All && Settings_Detail.Discount.ShowCouponInput%>" class="dnnFormItem">
                    <td >
                 ...
                 <!--  Order Memo  -->
                <tr id="Tr20" runat="server" visible="<%#Sellable && Settings_Detail.Order.ShowOrderMemo%>" class="dnnFormItem">
                    <td colspan="2">
                ...
                <!--  Order buttons  -->
                <tr id="Tr21" runat="server" visible="<%# Sellable || Settings_Detail.General.ShowAddWatch || Settings_Detail.General.ShowAddTicket%>">
                    <td colspan="2">
     ...
     <li id="Li8"  runat="server"  Visible='<%#objType.FieldEnable_License && Settings_Detail.General.ShowLicense && !string.IsNullOrEmpty(objProduct.License.Trim()) %>'>
       ...
       <li id="Li11"   runat="server"  Visible='<%#ShowGoogleMap %>'>
        <a href="#divGoogleMap"><span><%#Localization.GetString("tabGoogleMap",LocalResourceFile)%></span></a>
          ...
          <li id="Li12"    runat="server"  Visible='<%#HasDiscounts && Sellable && Settings_Detail.Discount.ShowDiscountTab %>'>
        <a href="#divDiscount"><span><%#Localization.GetString("tabDiscount",LocalResourceFile)%></span></a>
        </li>
           <li id="Li13"   runat="server"  Visible='<%#ShowAttachment %>'>
        <a href="#divAttachment"><span><%#Localization.GetString("tabAttachment",LocalResourceFile)%></span></a>
        </li>
           <li id="Li14" runat="server"  Visible='<%#ShowRelatedVideo %>'>
        <a href="#divRelatedVideo"><span><%#Localization.GetString("tabRelatedVideo",LocalResourceFile)%></span></a>
        </li>
          <li id="Li15"   runat="server"  Visible='<%#ShowRelatedAudio %>'>
        <a href="#divRelatedAudio"><span><%#Localization.GetString("tabRelatedAudio",LocalResourceFile)%></span></a>
        </li>
       
        
           <li id="Li17"   runat="server"  Visible='<%#ShowTransactionHistory %>'>
        <a href="#divTransactionHistory"><span><%#Localization.GetString("tabTransactionHistory",LocalResourceFile)%></span></a>
        </li>
        
           <li id="Li18"    runat="server"  Visible='<%#Settings_Detail.VendorProfile.ShowVendorProfile%>'>
        <a href="#divAboutAuthor"><span><%#Localization.GetString("tabAboutAuthor",LocalResourceFile)%></span></a>
        </li>
        
       <li id="Li19" runat="server" visible='<%#Settings_Portal.Rating.AllowRating && Settings_Detail.Rating.ShowRating && ( Sellable ||  objProduct.AllowRating )%>'>
            <a href="#divRating"><span>
                <%#Localization.GetString("tabRating",LocalResourceFile)%></span></a> 
         </li>
                
        <li id="Li20" runat="server" visible='<%#Settings_Portal.Comment.AllowComment && objProduct.AllowComment && Settings_Detail.Comment.ShowComment %>'>
            <a href="#divComment"><span>
                <%#Localization.GetString("tabComment",LocalResourceFile)%></span></a> 
        </li>
                
        <li id="Li21" runat="server" visible='<%#ShowRelatedProduct %>'><a  href='#divRelatedProduct'>
            <span>
