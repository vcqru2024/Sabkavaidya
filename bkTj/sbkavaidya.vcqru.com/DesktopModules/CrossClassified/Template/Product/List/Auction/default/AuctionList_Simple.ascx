    ...
    <tr valign="top">
        <td valign="top" align="left" height="<%=GetHeight()%>">
            ...
            <asp:GridView ID="grProduct" runat="server" AutoGenerateColumns="False" Visible="False"
                ...
                OnRowCommand="grProduct_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblStartPriceData" runat="server" Text='<%# Eval("StartPrice") %>'
                                Visible="<%#Settings_List.Content.ShowStartPrice %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblBuyNowPriceData" runat="server" Text='<%# Eval("BuyNowPrice") %>'
                                Visible="<%#Settings_List.Content.ShowBuyNowPrice %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblCurrentBidData" runat="server" Text='<%# GetCurrentBid(Convert.ToString(Eval("Id"))) %>'
                                Visible="<%#Settings_List.Content.ShowCurrentBid %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblCurrentBidder" resourcekey="lblCurrentBidderHead" runat="server"
                                Visible="<%#Settings_List.Content.ShowCurrentBidder %>" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblBidCountData" runat="server" Text='<%#GetBidCount(Convert.ToString(Eval("Id"))) %>'
                                Visible="<%#Settings_List.Content.ShowBidCount %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblPublishDateData" runat="server" Text='<%# Eval("PublishDate") %>'
                                Visible="<%#Settings_List.Content.ShowPublishDate %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblExpireDateData" runat="server" Text='<%# Eval("ExpireDate") %>'
                                Visible="<%#Settings_List.Content.ShowExpireDate %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblRemainTimeData" runat="server" Text='<%# GetRemainTime(Convert.ToString(Eval("Id"))) %>'
                                Visible="<%#Settings_List.Content.ShowRemainTime %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <HeaderTemplate>
