<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductList.ascx.cs" Inherits="Cross.Modules.CP_Product.View.ProductList" %>
...
<asp:Label ID="lblInvalidQuantity" runat="server" resourcekey="lblInvalidQuantity"
   ...
   <!-- Basic Search table -->
<table width="100%" cellpadding="0" cellspacing="0" id="tblBasicSearch" runat="server" class="dnnFormItem prdtbl"
     visible="false">
    <tr>
        <td>
          &nbsp; &nbsp;
...
<asp:Table ID="tblAdvancedSearchCondition" runat="server" Width="100%" CssClass="dnnFormItem prdtbl"
     Visible="false">
                         ...
                         <td align="left" valign="top">
                               ...
                               <%if (Settings_List.Content.ShowUserName)
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:Label ID="PromoEndLabel" runat="server" 
                                             Text='<%# Convert.ToDateTime(Eval("PromoEnd"))==DotNetNuke.Common.Utilities.Null.NullDate?"":Convert.ToDateTime(Eval("PromoEnd")).ToShortDateString() %>'
                                                Visible='<%#PromoPriceAvailable(Convert.ToString(Eval("Id")))&&Settings_List.Content.ShowPromoEnd %>' />
                                        </td>
                                    </tr>
                                    <%} %>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCreatedDate" runat="server" resourcekey="lblCreatedDate" Visible="<%#Settings_List.Content.ShowCreatedDate%>" />
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblFeatured" runat="server" resourcekey="lblFeatured" Visible="<%#Settings_List.Content.ShowFeaturedField %>" />
