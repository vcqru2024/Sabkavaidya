<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.CP_Product.View.UserBuyer_Order, App_Web_userbuyer_order.ascx.87459c53" %>
...
<table width="100%" class="dnnFormItem" cellpadding="0" cellspacing="0" border="0" runat="server"
    ...
    <tr>
        <td id="td_Button_Search" runat="server">
            ...
            <asp:Label ID="lblOrderNo1" runat="server" resourcekey="lblOrderNo1" />
            <asp:TextBox ID="txtOrderNo" Columns="40" runat="server" Width="200px" />
        ...
        <td>
            <asp:Label ID="lblOrderNo" runat="server" Visible="false" CssClass="SubHead" />&nbsp;&nbsp;
...
<table align="center" width="100%" class="dnnFormItem" id="tblOrderList" runat="server">
    <tr>
        <td align="right">
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="Both" BackColor="Gray"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblOrderNo" runat="server" resourcekey="lblOrderNo"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblOrderNoData" runat="server" Text='<%#Eval("OrderNo") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        <HeaderTemplate>
                            <asp:Label ID="lblOrderDate" runat="server" resourcekey="lblOrderDate"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblOrderDateData" runat="server" Text='<%#Eval("OrderDate") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblItemSummary" runat="server" resourcekey="lblItemSummary"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblItemSummaryData" runat="server" Text='<%#Eval("ItemSummary") %>'></asp:Label>
                        </ItemTemplate>
    ...
    <tr align="left" valign="top">
        <td>
            <cross:PagingControl ID="ctlPagingControl" runat="server" Mode="PostBack" OnPageChanged="ctlPagingControl_PageChanged"></cross:PagingControl>
        </td>
    </tr>
    <tr>
        <td>
...
<table align="center" width="100%" class="dnnFormItem" id="tblOrderDetail" runat="server">
    <tr>
        <td>
            <br />
            <asp:Label ID="lblOrderDetail" runat="server" ResourceKey="lblOrderDetail" CssClass="SubHead" />
            <br />
        ...
        <td>
            <div class="dnnTreeLegend">
                ...
                <div class="dtlItem">
                    ...
                    <asp:Literal ID="Literal1" runat="server" Text='<%#Localization.GetString("imgRating",LocalResourceFile)%>' /> 
                    <br />

                    <img alt="" id="Img4" runat="server" src="~/desktopmodules/crossclassified/images/download.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="Literal2" runat="server" Text='<%#Localization.GetString("imgViewDownload",LocalResourceFile)%>' />
                    <br />
                    <img alt="" id="Img6" runat="server" src="~/desktopmodules/crossclassified/images/up.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="litUpload_Client" runat="server" Text='<%#Localization.GetString("imgViewUpload_Client",LocalResourceFile)%>' />
                     <br />
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HyperLink ID="hlDownload" runat="server" Text='<%# Localization.GetString("hlDownload", LocalResourceFile) %>'
                                Target="_blank" NavigateUrl='<%#GetDownloadUrl(Convert.ToString(Eval("Id"))) %>' Visible='<%#Settings_Portal.Software.ShowSoftwareUrl %>' />
    ...
    <tr>
        <td>
            <div class="dnnTreeLegend">
                ...
                <div class="dtlItem">
                    <img alt="" id="Img5" runat="server" src="~/images/save.gif" />&nbsp;=&nbsp;
                    <asp:Literal ID="Literal3" runat="server" Text='<%#Localization.GetString("imgDownload", LocalResourceFile)%>' />
                </div>
            </div>
        </td>
    </tr>
...
<table id="tblOrderDetail_Upload_Client" cellspacing="0" cellpadding="2" border="0" align="left"
    ...
    <tr>
        <td>
            <asp:Label ID="lblUpload" runat="server" CssClass="SubHead" /><br />
            <br />
