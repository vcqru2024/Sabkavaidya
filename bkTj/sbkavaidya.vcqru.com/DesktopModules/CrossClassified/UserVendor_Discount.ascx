<%@ control language="C#" autoeventwireup="true" enableviewstate="true" inherits="Cross.Modules.CP_Product.View.UserVendor_Discount, App_Web_uservendor_discount.ascx.87459c53" %>
