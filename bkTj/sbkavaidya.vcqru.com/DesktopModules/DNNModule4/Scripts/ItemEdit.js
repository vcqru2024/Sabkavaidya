var DNNModule4 = DNNModule4 || {};

DNNModule4.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNNModule4",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNNModule4.user(result.id, result.name);
...
DNNModule4.user = function (id, name) {
    this.id = id;
    this.name = name;
}