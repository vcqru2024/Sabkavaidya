    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-lg-12 order-lg-2 ly-col-contentpane">
                ...
                <div id="carasoul" runat="server" containertype="G" containername="2shineBS5" containersrc="fullwidthWithoutPadding.ascx"></div>
                <div id="progressbar" runat="server" containertype="G" containername="2shineBS5" containersrc="fullwidthWithoutPadding.ascx"></div>
                <div id="FAQ" runat="server" containertype="G" containername="2shineBS5" containersrc="fullwidthWithoutPadding.ascx" class="saatvik-faq"></div>
