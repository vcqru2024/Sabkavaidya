    ...
    <tr>
        ...
        <td valign="top" align="left">
            <table cellspacing="2" cellpadding="2" width="100%"  align="left" runat="server">
                    <!-- current bid -->
                <tr runat="server" visible="<%# IsEnglishAuction && Settings_Detail.Auction.ShowCurrentBid %>">
                 ...
                 <!-- start price -->
                <tr  runat="server" visible="<%# Settings_Detail.Auction.ShowStartPrice %>">
                    <td>
                ...
                <tr runat="server" visible="<%# IsEnglishAuction && Settings_Detail.Auction.ShowIncrement %>">
                    <td  style="width:150px">
                 ...
                 <!-- remain time -->
                <tr runat="server" visible="<%# Settings_Detail.Auction.ShowRemainTime %>">
                    <td  style="width:150px">
                    ...
                    <td style="color: Green;">
                      ...
                      <!--  bid count -->
                <tr  runat="server" visible="<%# Settings_Detail.Auction.ShowBidCount %>">
                    <td  style="width:150px">
                ...
                <tr runat="server" id="trCurrentBidder">
                    ...
                    <!--  Stock Quantity   -->
                <tr  runat="server" visible="<%#IsSecondItemAuction && objProduct.StockQuantity >1 %>">
                    <td>
                    ...
                    <!--  Order Count   -->
                <tr runat="server" visible="<%#IsSecondItemAuction%>" >
                    <td >
                ...
                <tr runat="server" visible="<%# objProduct.Expired == false && objProduct.StockQuantity >0 %>">
                    <td   valign="middle">
               ...
               <tr>
                    <td colspan="2">
                     ...
                     <!-- buy now price  -->
                <tr runat="server" visible="<%# !IsSecondItemAuction &&  objProduct.BuyNowPrice > 0  && objProduct.Expired == false && objProduct.StockQuantity > 0%>">
                    <td  style="width:150px">
                 ...
                 <tr runat="server" visible="<%# !IsSecondItemAuction &&  objProduct.BuyNowPrice > 0  %>">
                    <td colspan="2">
                        <br />
                    </td>
                </tr>
                    <!-- reserve price -->
                <tr  runat="server" visible="<%# Settings_Detail.Auction.ShowReservePriceTip %>">
                    <td>
               ...
               <!--    AuctionStart -->
                 <tr  runat="server" visible="<%#Settings_Detail.Auction.ShowAuctionStart%>">
                    <td>
                  ...
                  <!--    AuctionEnd -->
                 <tr  runat="server" visible="<%#Settings_Detail.Auction.ShowAuctionEnd%>">
                    <td>
                ...
                <tr runat="server" visible="<%#Settings_Detail.General.ShowAuthor %>">
                 ...
                 visible="<%# Settings_Portal.Rating.AllowRating && Settings_Detail.Rating.ShowRating %>">
                   ...
                   <!--    country-->
                 <tr id="Tr1"   runat="server" visible="<%#Settings_Detail.General.ShowLocation_Country 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.Country)%>">
                    ...
                    <!--    State-->
                 <tr id="Tr2"  runat="server" visible="<%#Settings_Detail.General.ShowLocation_State 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.State)%>">
                   ...
                   <!--    City-->
                 <tr id="Tr3"    runat="server" visible="<%#Settings_Detail.General.ShowLocation_City 
                 && objType.AllowLocation && !string.IsNullOrEmpty(objProduct.City)%>">
                   ...
                   <!--    Town-->
                 <tr id="Tr4"    runat="server" visible="<%#Settings_Detail.General.ShowLocation_Town 
                ...
                <tr>
                   ...
                   <!--  shipping options  -->
                <tr  runat="server" visible='<%# objType.SellType == Convert.ToInt16(Cross.Modules.CP_Product.Business.SellType.Goods) && Settings_Detail.Auction.ShowAuctionShippingOption %>'>
                    <td>
...
<div id="tabs"  style="width: 100%; overflow:hidden">
     ...
     <li  runat="server"  Visible='<%#objType.FieldEnable_License && Settings_Detail.General.ShowLicense && !string.IsNullOrEmpty(objProduct.License.Trim()) %>'>
       ...
       <li   runat="server"  Visible='<%#ShowGoogleMap %>'>
        ...
        <a href="#divRelatedImage"><span><%#Localization.GetString("tabRelatedImage",LocalResourceFile)%></span></a>
           ...
           <li   runat="server"  Visible='<%#ShowBidHistory %>'>
       ...
       <li runat="server" visible='<%#Settings_Portal.Rating.AllowRating && Settings_Detail.Rating.ShowRating%>'>
        ...
        <li runat="server" visible='<%#ShowRelatedProduct %>'><a  href='#divRelatedProduct'>
           ...
           <li  runat="server"  Visible='<%#Settings_Detail.Auction.ShowAuctionExplaination %>'>
  ...
  {%>
   <div id="divAboutAuthor" style="height: 100%">
        <table cellspacing="2" cellpadding="2" width="100%" class="Normal">
            <!--    Company -->
            <tr id="Tr5" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowCompany && !string.IsNullOrEmpty(objAuthor.Company)%>">
                <td style="width:150px">
              ...
              <!--    country-->
                 <tr id="Tr6"   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowCountry && !string.IsNullOrEmpty(objAuthor.Country)%>">
                    <td style="width:150px">
                  ...
                  <!--    State-->
                 <tr id="Tr7"   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowState && !string.IsNullOrEmpty(objAuthor.State)%>">
                    <td style="width:150px">
                  ...
                  <!--    City-->
                 <tr id="Tr8"   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowCity && !string.IsNullOrEmpty(objAuthor.City)%>">
                    <td style="width:150px">
               ...
               <!--    Town-->
                 <tr id="Tr9" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowTown && !string.IsNullOrEmpty(objAuthor.Town)%>">
                    <td style="width:150px">
                  ...
                  <!--    Tel-->
                 <tr id="Tr10"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowTel && !string.IsNullOrEmpty(objAuthor.Tel)%>">
                    <td style="width:150px">
                  ...
                  <!--    Fax-->
                 <tr id="Tr11"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowFax && !string.IsNullOrEmpty(objAuthor.Fax)%>">
                    <td style="width:150px">
           ...
           <!--    Zipcode-->
                 <tr id="Tr12"   runat="server" visible="<%#Settings_Detail.VendorProfile.ShowZipcode && !string.IsNullOrEmpty(objAuthor.Zipcode)%>">
                    <td style="width:150px">
                 ...
                 <!--    IM-->
                 <tr id="Tr13"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowIM && !string.IsNullOrEmpty(objAuthor.IM)%>">
                    <td style="width:150px">
                ...
                <!--    Linkman-->
                 <tr id="Tr14" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowLinkman && !string.IsNullOrEmpty(objAuthor.Linkman)%>">
                    <td style="width:150px">
                ...
                <!--    Address-->
                 <tr id="Tr15"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowAddress && !string.IsNullOrEmpty(objAuthor.Address)%>">
                    <td style="width:150px">
                 ...
                 <!--    BusinessScope-->
                 <tr id="Tr16" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowBusinessScope && !string.IsNullOrEmpty(objAuthor.BusinessScope)%>">
                    <td style="width:150px">
                 ...
                 <!--    SiteUrl-->
            <tr id="Tr17" runat="server" visible='<%#Settings_Detail.VendorProfile.ShowSiteUrl 
            && !string.IsNullOrEmpty(objAuthor.SiteUrl) && objAuthor.SiteUrl.StartsWith("http")%>'>
                ...
                <!--    LogoUrl-->
                 <tr id="Tr18"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowLogoUrl && !string.IsNullOrEmpty(objAuthor.LogoUrl)%>">
                    <td style="width:150px">
                  ...
                  <!--    Slogan-->
                 <tr id="Tr19" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowSlogan && !string.IsNullOrEmpty(objAuthor.Slogan)%>">
                    <td style="width:150px">
                 ...
                 <tr id="Tr20"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField1 
                 ...
                 <tr id="Tr21"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField2 
                 ...
                 <tr id="Tr22" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField3 
                 ...
                 <tr id="Tr23"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField4 
                 ...
                 <tr id="Tr24" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField5 
                 ...
                 <tr id="Tr25" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField6 
                 ...
                 <tr id="Tr26" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField7 
                 ...
                 <tr id="Tr27"  runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField8 
                 ...
                 <tr id="Tr28" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField9 
                 ...
                 <tr id="Tr29" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowField10 
               ...
               <tr id="Tr30" runat="server" visible="<%#Settings_Detail.VendorProfile.ShowBiography  && !string.IsNullOrEmpty(objAuthor.Biography)%>">
                <td colspan="2">
                   <br />
