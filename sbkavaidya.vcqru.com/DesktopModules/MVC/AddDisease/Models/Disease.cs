...
namespace Saatvik.Modules.AddDisease.Models
{
    [TableName("AddDisease_Diseases")]
    //setup the primary key for table
    [PrimaryKey("DiseaseId", AutoIncrement = true)]
    //configure caching using PetaPoco
    [Cacheable("Diseases", CacheItemPriority.Default, 20)]
